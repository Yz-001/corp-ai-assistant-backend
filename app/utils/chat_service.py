...
请精确回答："""
            ...
            prompt = f"""请回答用户的问题。要求：
1. 回答简洁准确
2. 如果需要使用工具获取信息，请使用提供的工具
        ...
        if self.client:
            try:
                ...
                messages = [
                    {
                        "role": "system",
                        "content": "你是AI企业助手，一个专业、友好的AI助手。请根据提供的参考资料准确回答用户的问题。如果参考资料中有相关信息，请优先使用；如果没有，可以根据你的知识回答，但要说明这不是来自文档资料。如果用户请求需要使用工具（如读取文件、访问网页、查询物流等），请使用提供的工具。"
                    },
